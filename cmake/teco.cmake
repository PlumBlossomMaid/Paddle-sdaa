...
find_path(
  TECOCUSTOM_EXT_INC
  NAMES "tecocustom_ext.h" "tecodnn_custom.h"
  PATHS ${TECOCUSTOM_EXT_PATH}/include ${CMAKE_SOURCE_DIR}
  NO_DEFAULT_PATH)
find_library(
  TECOCUSTOM_EXT_LIB
  NAMES "tecocustom" "tecodnn_ext"
...
elseif(NOT TECOCUSTOM_EXT_INC)
  message(FATAL
          "Cannot find tecocustom_ext.h or tecodnn_custom.h in ${TECOCUSTOM_EXT_PATH}/include or ${CMAKE_SOURCE_DIR}")
elseif(NOT TECOCUSTOM_EXT_LIB)
  message(FATAL "Cannot find libtecocustom or libtecodnn_ext in ${TECOCUSTOM_EXT_PATH}/lib")
endif()
